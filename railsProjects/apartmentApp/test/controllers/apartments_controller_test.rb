...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { bathrooms: @apartment.bathrooms, bedrooms: @apartment.bedrooms, cost: @apartment.cost, monthly: @apartment.monthly }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { bathrooms: @apartment.bathrooms, bedrooms: @apartment.bedrooms, cost: @apartment.cost, monthly: @apartment.monthly }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
