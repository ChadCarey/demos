...
class PunchcardsControllerTest < ActionController::TestCase
  ...
  test "should create punchcard" do
    assert_difference('Punchcard.count') do
      post :create, punchcard: { timein: @punchcard.timein, timeout: @punchcard.timeout, user_id: @punchcard.user_id }
    end
  ...
  test "should update punchcard" do
    patch :update, id: @punchcard, punchcard: { timein: @punchcard.timein, timeout: @punchcard.timeout, user_id: @punchcard.user_id }
    assert_redirected_to punchcard_path(assigns(:punchcard))
  end
